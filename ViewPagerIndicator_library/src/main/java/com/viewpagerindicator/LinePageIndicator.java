...
public class LinePageIndicator extends View implements PageIndicator {
    ...
    private int measureWidth(int measureSpec) {
        ...
        /**
         * Leon 解决 return (int)FloatMath.ceil(result);
         * Android6.0不支持FloatMath.sin()了，主要有两个方法可以解决。
         解决：
         1,用23一下的SDK版本进行编译。将gradle.build文件里（包括project的gradle.build和module的gradle.build）
         的compileSdkVersion设为23以下。
         2,用Math类替换FloatMath类，Math.sin()和Math.ceil();
         我用的是第二个方案，因为随着版本更新，早晚我们要用6.0，哈哈
         重新clean了一下，run起来没有问题
         ---------------------
         作者：daoxiaomianzi
         来源：CSDN
         原文：https://blog.csdn.net/daoxiaomianzi/article/details/53156777
    ...
    private int measureHeight(int measureSpec) {
        ...
        /**
         * Leon解决： return (int)FloatMath.ceil(result);
         * Android6.0不支持FloatMath.sin()了，主要有两个方法可以解决。
         解决：
         1,用23一下的SDK版本进行编译。将gradle.build文件里（包括project的gradle.build和module的gradle.build）
         的compileSdkVersion设为23以下。
